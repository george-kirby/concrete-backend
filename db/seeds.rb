...
incomplete_steps: ["go to offy", "1 rose, 1 red, 3 white", "some rum too"]
)
...
tags: ["bob's party"],
incomplete_steps: ["open wardrobe, choose from shirts to wear", "set up ironing board and iron"]
)
...
tags: ["bob's party"],
incomplete_steps: ["sit at desk with pen and card"]
)
...
tags: ["bob's party"],
incomplete_steps: ["phone, search maps for Bob's address"]
)
